...
/// <summary>
/// Client cosmetic for the Dart tower. Behaviour currently mirrors <see cref="ClientCircleTowerCombat"/>,
/// but lives in its own type so the Dart tower can diverge from Circle later.
/// </summary>
public class ClientDartTowerCombat : BaseClientTowerCombat
{
    [Title("Dart Client Tower References")]
    [SerializeField] private EntityTeam entityTeam;

    /// <summary>
    /// Called by the server (via ServerDartTowerCombat) to notify clients of a shot.
