...
namespace LunaWolfStudiosEditor.ScriptableSheets.Layout
{
	public class SettingsContent : Content
	{
		...
		{
			public static readonly GUIContent ArraySize = new GUIContent("Min Size", "Specify the minimum number of columns to display for arrays and other collections.\n\nSupports up to 5000 entries per array, with an additional column limit determined by <b>Max Iterations</b> under Workload Settings.");
		...
		public static class Label
		{
			...
			public static readonly GUIContent ScannerExcludedPaths = new GUIContent("Excluded Paths", "Folders to exclude from asset scanning. Paths are case-insensitive and recursive. Must start from the root of the Unity project.\nExample: \"Assets/MyFolder\" or \"Packages/MyPackage/\".\n\nTypes discovered via Assembly <b>Scan Option</b> are included even if all their instances are excluded.\n\nRescan after changing exclusions.");
			public static readonly GUIContent ScannerExcludedFullTypeNames = new GUIContent("Excluded Full Type Names", "Full type names and namespaces to exclude. Types are case-insensitive and recursive.\nExample: \"MyNamespace.MyScriptableObject\".\n\nRescan after changing exclusions.");
		...
		public static class Toggle
		{
			...
			public static readonly GUIContent BestFitArraySize = new GUIContent("Best Fit", "Enable to use the largest array size found within all Objects for each array. Disable to improve performance with arrays.\n\nThe maximum size is still capped by <b>Max Iterations</b> under Workload Settings.");
			...
			public static readonly GUIContent OverrideArraySize = new GUIContent("Override Size", "Enable to override the minimum number of columns displayed for each array. When disabled it will use the first non-sorted Objects array sizes. Disable to improve performance with arrays.");
